...
export default async (req, res) => {
    try {
        ...
        // Create Notification for Admin (Department/ULB)
        await Notification.create({
            id: randomID(),
            departmentID: body.departmentID,
            ulbID: body.ulbID,
            title: `New Issue: ${body.title}`,
            message: `${body.username} has reported a new issue: ${body.title}`,
            type: "NEW_ISSUE",
        ...
        await Notification.create({
            ...
            userID: body.userID,
            title: "Issue Created",
            message: `You have successfully reported an issue: ${body.title}`,
            type: "NEW_ISSUE",
            issueID: issueObject.id,
        });
